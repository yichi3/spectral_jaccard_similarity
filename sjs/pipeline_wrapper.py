...
for i in range(len(datasetLst)):
    ...
    bact, num_jobs, numHashes)
    print(cmd_1)
    os.system(cmd_1)

    cmd_12 = "python generateRandReads.py  --dataset {}_filtered --num_jobs {}  --num_reads {} --num_hashes {}".format(
    	bact, num_jobs, numRandReads, numHashes)
    print(cmd_12)
    os.system(cmd_12)
    ...
    cmd_2 = "python runSVDexperiments_pipelined.py --dataset {}_filtered --num_jobs {}  --num_rand {} --num_hashes {}".format(
    	bact, num_jobs, numRandReads, numHashes)
    print(cmd_2)
    os.system(cmd_2)
    # break
